...
<Code language="tsx" id="RdflibLocalDemo" code={localDemoCode} className="line-numbers">
    <CodeStep lines={["13"]} title="Store setup">
        Setting up the store that's going to contain our data.
    </CodeStep>
    <CodeStep lines={["16", "20", "30", "40"]} title="Error handling">
    ...
    <CodeStep lines={["19-22"]} title="Parsing turtle and loading name">
    ...
    <CodeStep lines={["31-37"]} title="Updating turtle in `localStorage` and name">
