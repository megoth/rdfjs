...
<Code language="tsx" id="RdflibLocalDemo" code={localDemoCode} className="line-numbers">
    ...
    <CodeStep lines={["14-17"]} title="Parsing turtle and loading name">
        Loading existing data from either default turtle or saved turtle from `localStorage`.
    </CodeStep>
    <CodeStep lines={["22-28"]} title="Updating turtle in `localStorage` and name">
