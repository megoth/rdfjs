...
<Code language="tsx" id="RdflibLocalDemo" code={localDemoCode} className="line-numbers">
    <CodeStep lines={["10"]} title="Store setup">
        Setting up the store that's going to contain our data.
    </CodeStep>
    <CodeStep lines={["13", "17", "27", "37"]} title="Error handling">
    ...
    <CodeStep lines={["16-19"]} title="Parsing turtle and loading name">
    ...
    <CodeStep lines={["28-34"]} title="Updating turtle in `localStorage` and name">
