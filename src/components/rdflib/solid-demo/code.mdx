...
<Code language="tsx" id="RdflibSolidDemo" code={solidDemoCode} className="line-numbers">
    <CodeStep lines={["13-16"]} title="Store setup">
    ...
    <CodeStep lines={["19", "24", "32", "42"]} title="Error handling">
    ...
    <CodeStep lines={["22-23"]} title="Loading data and setting name">
    ...
    <CodeStep lines={["33-39"]} title="Submitting data and updating name">
