...
<Code language="tsx" id="RdflibSolidDemo" code={solidDemoCode} className="line-numbers"
      url="https://github.com/megoth/rdfjs/blob/main/src/components/rdflib/solid-demo/index.tsx">
    <Walkthrough>
        <tr>
            <td>
                <CodeLink id="RdflibSolidDemo" lines={["9-12"]}>Store setup</CodeLink>
            </td>
            <td>
        ...
        <tr>
            <td>
                <CodeLink id="RdflibSolidDemo" lines={["18"]}>Loading data and setting name</CodeLink>
            </td>
            <td>
        ...
        <tr>
            <td>
                <CodeLink id="RdflibSolidDemo" lines={["22-25"]}>Submitting data and updating name</CodeLink>
            </td>
            <td>
