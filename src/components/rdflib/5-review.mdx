...
<AuthorNote id="review" title="Should you choose rdflib.js?">
    ...
    <Content id={RATING_CRITERIA[3][0]}>
        rdflib.js is probably the oldest JavaScript library that supports RDF. Hence, it sports a tried-and-tested API
        that you can be sure has most bugs ironed out.
    </Content>
