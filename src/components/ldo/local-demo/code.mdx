...
<Code language="tsx" id="LDOLocalDemo" code={localDemoCode} className="line-numbers">
    <CodeStep lines={["11-12"]} title="Setting up profile and turtle">
    ...
    <CodeStep lines={["15-18"]} title="Parsing turtle and updating profile">
    ...
    <CodeStep lines={["21-23"]} title="Loading state">
    ...
    <CodeStep lines={["26-27"]} title="Updating name and storage">
