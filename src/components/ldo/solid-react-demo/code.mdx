    ...
    <Walkthrough>
        <tr>
            ...
            <td>
                ...
                [@ldo/solid-react](https://github.com/o-development/ldobjects/tree/main/packages/solid-react) that allow
                us to 1) fetch the WebID resource, and 2) retrieve it packaged as a `SolidProfile`. This is another
                example of the ease LDO allow you to express your code.
            </td>
        </tr>
        <tr>
            <td>
