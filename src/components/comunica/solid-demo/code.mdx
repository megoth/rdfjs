...
<Code language="tsx" id="ComunicaSolidDemo" code={demoCode} className="line-numbers">
    ...
    <CodeStep lines={["17-28"]} title="Retrieving name">
    ...
    <CodeStep lines={["37-45"]} title="Updating online graph">
