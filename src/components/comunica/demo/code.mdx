...
<Code language="tsx" id="ComunicaSolidDemo" code={demoCode} className="line-numbers">
    <CodeStep lines={["6"]} title="Bootstrapping engine">
    ...
    <CodeStep lines={["33-41"]} title="Updating online graph">
