...
<Content>
    <h2 className="Beyond RDF">Beyond RDF</h2>

    After RDFs initial standardization in 1999 it has had multiple extensions, and we now have ways of describing
    vocabularies, logical relationships, and infer new knowledge based. Vocabularies (like FOAF) allow us to formally
    ...
    [SHACL](https://shacl.org/) and [ShEx](http://shex.io/) as the most promising technologies.
