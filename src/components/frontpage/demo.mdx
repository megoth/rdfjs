...
<Content>
    This code is written in TSX, a language that combines Typescript and ESM files. It's specifically written with React
    in mind, and relies a lot on [React Hooks](https://react.dev/reference/react). That said, I think the overall
    abstractions are clear, and I'll walk through the various parts:
</Content>

<Code language="tsx" id={"FrontpageDemoCode"} code={demoCode}>
    <Walkthrough>
        <tr>
            <td>
            ...
            <td>
                ...
                manages the data flow of our form element at line 36. Also note `useEffect` at line 24, that updates the
        ...
        <tr>
            ...
            <td>
                ...
                servers. Given this behavior, we want to limit when user can submit updates. At line 34 and 48 we see
                that whenever a name isn't defined yet, we simply show the component loading.
            </td>
        </tr>
        <tr>
    ...
    <Content>
        ...
        logic of the demo resides (and which we show in the respective code section). It basically only provides a form
        that calls on `onSubmit` when submitted.
    </Content>
</Code>