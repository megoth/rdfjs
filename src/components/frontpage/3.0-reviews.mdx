...
import DeveloperExperienceSection from "./3.1-devx.mdx";
import DocumentationSection from "./3.2-docs.mdx";
import CommunitySection from "./3.3-community.mdx";
import MaturitySection from "./3.4-maturity.mdx";
import OverallSection from "./3.5-overall.mdx";
...
<AuthorNote title={"My opinion on the matter"}>
    <Content>
        ...
        your needs (and for which they lack). For each demo I break down my impressions by categories, and I'll try to
        assess how good a library is on the given category by rating it from 1 to 5. I'll describe what each
