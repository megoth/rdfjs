...
<Code language="tsx" id="InruptSolidDemo" code={solidDemoCode} className="line-numbers">
    ...
    <CodeStep lines={["15-17"]} title="Getting profile and name">
    ...
    <CodeStep lines={["18", "24", "32", "37", "41"]} title="Error handling">
    ...
    <CodeStep lines={["21-23"]} title="Fetching resource and parsing dataset">
        Using `getSolidDataset` we have an easy, asynchronous function to get the dataset.
    </CodeStep>
    <CodeStep lines={["27-29"]} title="Loading state">
        Again, similar approach like the local demo.
    </CodeStep>
    <CodeStep lines={["33-37"]} title="Updating online resources upon submit">
