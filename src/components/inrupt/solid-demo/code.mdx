...
<Code language="tsx" id="InruptSolidDemo" code={solidDemoCode} className="line-numbers">
    <Walkthrough>
        ...
        <tr>
            <td>
                <CodeLink id="InruptSolidDemo" lines={["16-20"]}>Getting profile and name</CodeLink>
            </td>
            <td>
        ...
        <tr>
            <td>
                <CodeLink id="InruptSolidDemo" lines={["26-27"]}>Fetching resource and parsing dataset</CodeLink>
            </td>
            <td>Using `getSolidDataset` we have an easy, asynchronous function to get the dataset.</td>
        </tr>
        <tr>
            <td>
                <CodeLink id="InruptSolidDemo" lines={["30-32"]}>Loading state</CodeLink>
            </td>
            <td>Again, similar approach like the local demo (as well as same flaw, same excuse).</td>
        </tr>
        <tr>
            <td>
                <CodeLink id="InruptSolidDemo" lines={["35-38"]}>Updating online resources upon submit</CodeLink>
            </td>
            <td>
