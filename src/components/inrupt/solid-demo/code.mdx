...
<Code language="tsx" id="InruptSolidDemo" code={solidDemoCode} className="line-numbers">
    <Walkthrough>
        <tr>
            <td>
                <CodeLink id="InruptSolidDemo" lines={["13-14"]}>Setting up dataset and session</CodeLink>
            </td>
            <td>
        ...
        <tr>
            <td>
                <CodeLink id="InruptSolidDemo" lines={["15-16"]}>Getting profile and name</CodeLink>
            </td>
            <td>
        ...
        <tr>
            <td>
                <CodeLink id="InruptSolidDemo" lines={["19-20"]}>Fetching resource and parsing dataset</CodeLink>
            </td>
            <td>Using `getSolidDataset` we have an easy, asynchronous function to get the dataset.</td>
        </tr>
        <tr>
            <td>
                <CodeLink id="InruptSolidDemo" lines={["23-25"]}>Loading state</CodeLink>
            </td>
            <td>Again, similar approach like the local demo (as well as same flaw, same excuse).</td>
        </tr>
        <tr>
            <td>
                <CodeLink id="InruptSolidDemo" lines={["28-31"]}>Updating online resources upon submit</CodeLink>
            </td>
            <td>
