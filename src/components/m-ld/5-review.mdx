...
<AuthorNote id="review" title="Should you choose m-ld?">
    I haven't used m-ld for a long time, but I'm impressed with what it already offers. But I'm also impressed by the
    ambitions of the team working on it, planning to eventually support a common API across multiple platforms is an
    impressive feat (if they're able to do it), and should make it a perfect choice for organizations that need that.
