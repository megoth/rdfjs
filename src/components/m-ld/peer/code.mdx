...
<Code language="tsx" id="PeerDemoCode" code={peerDemoCode} className="line-numbers">
    <CodeStep lines={["15-16"]} title={<>Getting <code>domainId</code> and setting <code>domainUrl</code></>}>
    ...
    <CodeStep lines={["17", "23-28", "40"]} title="Connecting to the network">
    ...
    <CodeStep lines={["18", "29-40"]} title="Read initial model and updates">
    ...
    <CodeStep lines={["50-55", "58"]} title="Submit form and update network">
    ...
    <CodeStep lines={["19", "42", "48", "56-58", "63-68"]} title="Error handling">
    ...
    <CodeStep lines={["69"]} title="Do not notify the user">
