...
<Content>
    ...
    Last, note that the demos pass JSON-objects that use `foaf:name` to ensure interoperability using the [FOAF
    vocabulary](http://xmlns.com/foaf/0.1/) - the same vocabulary I've used in some way in all the other demos. (If you
    think this is unnecessary, you could simply pass an JSON object - just remember the `@id`-property.)
</Content>
