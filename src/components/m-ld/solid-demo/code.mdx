...
<Code language="tsx" id="SolidDemo" code={solidDemoCode} className="line-numbers">
    <CodeStep lines={["13-16", "25-26"]} title="Load resource and profile">
    ...
    <CodeStep lines={["41-50"]} title="Relaying updates to Solid">
        Whenever an updated name is submitted I pass the new value so that the WebID resource is updated.
    </CodeStep>
    <CodeStep lines={["43"]} title="Let user know that something went wrong">
