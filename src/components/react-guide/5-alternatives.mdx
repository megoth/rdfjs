...
<Content>
    ...
    * [Solid.js](https://www.solidjs.com/): An up-and-coming library that features blazingly fast state handling with
    ...
    The point is that it's my weapon of choice, and you are free to use whichever you want. I truly believe that overall
    abstractions that the code convey are useful enough to make you able to transport the core parts of into your own
    weapon of choice.
</Content>
