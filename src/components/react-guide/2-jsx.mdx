...
<Content>
    And our component, `JsxExample`, is then reused again in the code running this page as well, as seen in
...
<AuthorNote title="It's actually MDX!">
    ...
    But don't you love how self-referential we can be when coding? (I couldn't let this chance go =P )
</AuthorNote>
...
<AuthorNote title="It's actually TSX!">
    ...
    so nice to work with ^_^ (well, for me at least =P )
</AuthorNote>
