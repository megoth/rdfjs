...
<Content>
    ...
    title="Three-Letter Acronym">TLA</abbr> (a joke here is that TLA is itself a three-letter acronym), i.e. not very
    accessible for those outside the know. Linked Data at least gives an inkling of what it's about: **linking
    *meaningful* data together in knowledge graphs**.
    ...
    it. Throughout this text I'll be very firm about the use of the words Knowledge Graph and Linked Data. **Knowledge
    Graph** will denote the *abstraction of knowledge graphs*, while **Linked Data** will denote the *specific type of
    knowledge graph using RDF*. (There, that's the last time I'll use that TLA for this text.)
</Content>
