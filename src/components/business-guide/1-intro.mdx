...
<Content>
    ...
    Data. **Knowledge Graph** will denote the *abstraction of knowledge graphs*, while **semantic knowledge graphs**
    will denote the *specific type of knowledge graph using RDF*. (There, that's the last time I'll use that TLA for
    this text.)
</Content>
